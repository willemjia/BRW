...
!function () {
    ...
    a.directive("fusioncharts", ["$http", function (a) {
        return{scope: {width: "@", height: "@", data: "@", dataset: "@", categories: "@", chart: "@", linkeddata: "@", trendlines: "@", vtrendlines: "@", annotations: "@", colorrange: "@", lineset: "@", axis: "@", connectors: "@", pointers: "@", value: "@", processes: "@", tasks: "@", rows: "@", columns: "@", map: "@", markers: "@"}, link: function (a, b, c) {
            var d, e, f, g, h, i, j, k, l, m, n, o = {NDCObserver: {width: {ifExist: !1, observer: function (b) {
                b && j.width != b && (j.width = b, r.resizeTo(a.width, a.height))
            }}, height: {ifExist: !1, observer: function (b) {
                b && j.height != b && (j.height = b, r.resizeTo(a.width, a.height))
            }}, datasource: {ifExist: !0, observer: function (a) {
            ...
            }}, type: {ifExist: !1, observer: function (a) {
                a && j.type != a && (j.type = a, u())
            }}, config: {ifExist: !1, observer: function (a) {
                var b, c, d = !1;
                if (a) {
                    b = JSON.parse(a);
