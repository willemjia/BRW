!function (e, t) {
    ...
    "use strict";
    function e(e, t, n) {
        return{restrict: "AE", replace: !0, scope: {inputObj: "=inputObj"}, link: function (a, o, i) {
            function l() {
            ...
            function s() {
                ...
                var t = new Date(e.getFullYear(), e.getMonth(), e.getDate()), n = {date: e.getDate(), month: e.getMonth(), year: e.getFullYear(), day: e.getDay(), dateString: e.toString(), epochLocal: t.getTime(), epochUTC: t.getTime() + 60 * t.getTimezoneOffset() * 1e3};
            ...
            a.today = {dateObj: b, date: g.getDate(), month: g.getMonth(), year: g.getFullYear(), day: g.getDay(), dateString: g.toString(), epochLocal: g.getTime(), epochUTC: g.getTime() + 60 * g.getTimezoneOffset() * 1e3};
            var h = function (e) {
                var t = e.getTime();
                ...
                for (var o = t; n >= o; o++) {
                    ...
                    a.dayList.push({date: i.getDate(), month: i.getMonth(), year: i.getFullYear(), day: i.getDay(), dateString: i.toString(), dateDisabled: l}), i.getDate() == e.getDate() && a.dateSelected(a.dayList[a.dayList.length - 1])
                }
            ...
            }, a.date_selection = {selected: !1, selectedDate: "", submitted: !1}, a.date_selection.selected = !0, a.date_selection.selectedDate = a.ipDate, a.dateSelected = function (e) {
            ...
            var y = {dateObj: a.ipDate, date: a.ipDate.getDate(), month: a.ipDate.getMonth(), year: a.ipDate.getFullYear(), day: a.ipDate.getDay(), dateString: a.ipDate.toString(), epochLocal: a.ipDate.getTime(), epochUTC: a.ipDate.getTime() + 60 * a.ipDate.getTimezoneOffset() * 1e3};
            a.dateSelected(y), a.$watch("date_selection.selectedDate", function (e, t) {
                ...
                c(), a.closeModal()
            }, "modal" === a.templateType.toLowerCase() && (t.fromTemplateUrl("ionic-datepicker-modal.html", {scope: a, animation: "slide-in-up"}).then(function (e) {
                a.modal = e
                ...
                m(a.inputObj.inputDate ? a.inputObj.inputDate : a.date_selection.selectedDate ? a.date_selection.selectedDate : a.ipDate ? angular.copy(a.ipDate) : new Date), "modal" === a.templateType.toLowerCase() ? a.openModal() : a.popup = e.show({templateUrl: "ionic-datepicker-popup.html", title: a.titleLabel, subTitle: "", cssClass: "picker-body", scope: a, buttons: r})
            })
        }}
    }
    ...
    "use strict";
    function e() {
        this.monthsList = ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"], this.getYearsList = function (e, t) {
            var n = [], a = 1900, o = 2100;
