 ...
 * 应收票据
 *********************************************************/
  .controller('receive_billCtrl', function ($scope,$state,services,  $ionicPopover, $rootScope,$ionicLoading) {
  $scope.resp=[];//返回的数据
...
//        });
  ...
  .controller('receive_bill_searchCtrl', function ($scope, services, $state, $ionicPopup, $timeout) {
