angular.module('TEYCtrl',[])
  /*******************************************************
   * 班组设备产量
   *********************************************************/
  .controller('TEYCtrlCtrl', function ($scope,$state,services,  $ionicPopover, $rootScope,$ionicLoading) {
    $scope.resp=[];//返回的数据
...
//        });
  ...
  .controller('TEY_detailedCtrl', function ($scope, $rootScope) {
    $scope.mingxi=$rootScope.mingxi;
  })
  .controller('TEY_searchCtrl', function ($scope, services, $state, $ionicPopup, $timeout) {
  ...
  .controller('TEY_hideCtrl', function ($scope, $rootScope, $state) {
    /*************************************************************************
     * 隐藏列
     *************************************************************************/
    $scope.data = {
